...
% Turkish document labels. ElegantBook uses its English mode as the base
...
% ── Residual CJK glyphs ──────────────────────────────────────────
% Chinese terminology and tokenization examples occur throughout the Turkish
...
\newtcolorbox{questionbox}{
  ...
  title={\sffamily\bfseries Derin Düşünme},
