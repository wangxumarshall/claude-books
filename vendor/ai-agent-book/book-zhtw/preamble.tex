...
% 正文中文字体：本地 macOS 用 Songti TC / Heiti TC；CI（无 Apple 字体）用 Noto Sans CJK TC。
...
\IfFontExistsTF{Songti TC}{%
  ...
  \setCJKmainfont[AutoFakeBold=2.5]{Noto Sans CJK TC}%
  \setCJKsansfont[AutoFakeBold=2.5]{Noto Sans CJK TC}%
  \setCJKmonofont[AutoFakeBold=2.5]{Noto Sans CJK TC}%
}
