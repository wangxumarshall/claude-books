% ===== ElegantBook customizations for Vietnamese "Hiểu sâu về AI Agent" =====
% Accent color comes from ElegantBook's cyan theme: \structurecolor = RGB(31,186,190)

% ── Vietnamese labels for the ElegantBook Chinese layout ─────────
% Keep lang=cn in the build script because it loads xeCJK/ctex reliably on this
% setup, but override every visible Chinese label used by the class.
...
\renewcommand{\xchaptertitle}{Chương \thechapter}
...
% Internal cross-reference links (figure/chapter refs) — clickable + subtle teal,
...
\newtcolorbox{questionbox}{
  ...
  title={\sffamily\bfseries Suy nghĩ sâu},
...
% x-height — wrong for CJK, whose glyphs should sit at the nominal point
...
% faux bold, so fallback glyphs match the Latin in captions. Injected into captions only;
