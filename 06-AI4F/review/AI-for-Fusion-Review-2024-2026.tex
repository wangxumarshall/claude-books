...
Conlin et al.~\citep{Conlin2024Nature} applied differentiable programming using automatic differentiation (JAX) to the entire stellarator optimization pipeline, published in \textit{Nature}.
