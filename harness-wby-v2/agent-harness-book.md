...
本书受美国及国际版权法保护。未经出版商书面许可，不得以任何形式或通过任何方式（电子、机械、影印、录音或其他方式）复制、传播本书的任何部分。

**免责声明**：本书中的信息按"原样"提供，不对信息的准确性、完整性、适销性或特定用途适用性提供任何明示或暗示的保证。作者和出版商不对使用本书内容可能造成的任何直接或间接损失承担责任。

**商标声明**：本书中提及的所有产品名称、标识和商标均为其各自所有者的财产。
...
2026年，AI Agent正在进入生产环境的关键阶段。然而，当前行业普遍存在一个危险的假设：认为只要模型足够强大，就能够可靠地完成复杂任务。这是一个根本性的误区。

大型语言模型（LLM）是概率系统——它们的输出本质上是不可预测的。当我们将这些概率性的"智能"系统部署到生产环境时，我们面对的不是一只训练有素的猎犬，而是一头随时可能失控的野兽。

**本书的核心论点是：Better harnesses outperform better models.**

确定性（Harness）优于智能（Model）。这不是说模型不重要——模型是必要的燃料。但真正决定成败的，是围绕模型构建的确定性框架（Harness）。一个精心设计的Harness可以让普通模型超越未受约束的最强模型。

## 本书面向的读者

本书面向以下读者：

- **AI工程师与架构师**：需要将AI Agent部署到生产环境的专业人员
- **技术负责人与CTO**：负责AI技术选型和架构决策的领导者
- **学术研究者**：对AI安全、可信系统、编程语言理论感兴趣的研究人员
- **DevOps与平台工程师**：需要为AI Agent提供可靠运行基础设施的工程师

## 如何使用本书

本书的组织遵循渐进式复杂度递增的原则：

- **第0-2章**：建立理论基础，理解Harness不变量的核心概念
- **第3-6章**：深入语言层，从TypeScript到Rust到Go，逐层递进
- **第7-12章**：构建工程能力，从编译器集成到事务性无回归
- **第13-15章**：实战路径，从起步到进阶到极致阶段

建议读者按顺序阅读前12章，第13-15章可根据自身需求选择参考。
...
```
第0章  Big Model vs Big Harness —— 回应当前核心辩论  ................ 1
第1章  Harness不变量理论导论  ................................... 15
第2章  TypeScript——应用层类型不变量  ............................. 55
第3章  Rust——核心层类型不变量与状态不变量  ....................... 115
第4章  Go——并发层状态不变量  ..................................... 185
第5章  编译器作为状态不变量的判别器  ............................. 255
第6章  编译器驱动的开发闭环  ..................................... 315
第7章  事务性无回归（TNR）  ...................................... 375
第8章  四维案例矩阵  ............................................. 425
第9章  WebAssembly——执行不变量的物理牢笼  ........................ 485
第10章 MCP协议与工具隔离  ........................................ 545
第11章 状态持久化与DAG架构  ...................................... 605
第12章 全链路可观测性与人在回路  ................................. 665
第13章 起步阶段（TypeScript栈）  ................................. 725
第14章 进阶阶段（Rust + WASM栈）  ............................... 785
第15章 极致阶段（Anthropic/StrongDM级）  ......................... 845
附录A  术语表  .................................................... 905
附录B  代码索引  .................................................. 935
附录C  参考文献（带评级）  ........................................ 965
附录D  框架对比矩阵  .............................................. 995
...
5. 本书的立场：Harness不变量理论提供模型无关的安全框架# 第1章：Harness不变量理论导论
...
4. GRT栈各司其职，形成完整防线
5. **公理+引理+定理**体系确立Harness不变量理论的完备性# 第2章：TypeScript —— 应用层类型不变量
...
4. 官方数据显示成功率从80%提升至96%（D级数据，需独立验证）# 第3章：Rust —— 核心层类型不变量与状态不变量
...
4. 学术数据支撑：Rustine 87%等价性，SafeTrans 54%→80%成功率# 第4章：Go —— 并发层状态不变量
...
3. Go在GRT栈中负责高并发编排层
4. 单一二进制部署适合边缘场景# 第5章：编译器作为状态不变量的判别器
...
4. 干预策略：警告 → 提示 → 回滚 → 终止# 第7章：事务性无回归（TNR）
...
**开放世界假设定义**：
1. Agent可以调用外部API或工具，这些调用的副作用不在Agent控制范围内
2. Agent的修复操作可能包含不可逆操作（如发送邮件、执行交易）
3. 外部攻击者可以在修复过程中介入

**形式化表述**：

设 $\text{Fix}$ 为包含外部调用的修复操作，则：

$$\exists s \in S, \text{Fix}(s) = s' \land \text{ExternalEffect}(s') \neq \emptyset$$

其中 $\text{ExternalEffect}$ 表示无法被Undo Stack撤销的外部副作用。
...
Undo Stack仅保存本地状态快照，无法撤销 $e$。若 $f$ 返回后才发现需要回滚，$e$ 已不可挽回。故不存在能够保证"修复失败时系统状态绝不恶化"的通用算法。∎
...
5. **TNR不可能性定理**：开放世界假设下，外部副作用无法被撤销——这是重要的学术诚实性边界声明# 第8章：四维案例矩阵 —— 工程实践全景
...
5. 共同特点： Harness成熟度决定自动化程度# 第9章：WebAssembly —— 执行不变量的物理牢笼
...
5. 真实安全事件证明隔离的重要性# 第10章：MCP协议与工具隔离
...
Leash通过在操作系统内核层面拦截MCP工具调用，实现了真正的零信任安全模型。所有工具调用都必须经过策略引擎的实时验证，确保符合预定义的安全策略。这种架构不仅提供了强大的安全保障，还保持了极低的运行时开销。# 第11章：状态持久化与DAG架构
...
这种不可变DAG架构为AI系统提供了坚实的状态管理基础，确保了复杂工作流的可靠性和可维护性。# 第12章：全链路可观测性与人在回路
...
这种实时干预能力使得安全团队能够在不中断正常业务的情况下，快速响应新兴威胁和合规要求，为AI系统提供了动态的安全防护层。# 第13章：起步阶段（TypeScript栈）
...
（参考第7章《TNR架构》的Rust代码，展示完整实现）# 第15章：极致阶段（Anthropic/StrongDM级）
...
| Durable Execution | Durable Execution | 持久化执行，支持断点续传 |# Appendix B: 代码索引
...
## 第12章：可观测性
- ApprovalRequest TypeScript (`manuscript/volume-3-runtime/chapter-12-observability.md`)# Appendix C: 参考文献（带评级）
...
| Mastra | 80%→96%成功率 | 官方数据 | ⚠️ 待核实 |# Appendix D: 框架对比矩阵
